#1. Переменной var_int присвойте значение 10, var_float - значение 8.4, var_str -
# "No".
...
#5. Измените значение переменной var_str на "NoNoYesYesYes". При
# формировании нового значения используйте операции конкатенации (+) и
# повторения строки (*).
...
var_str = var_str + 'NoNoYesYesYes';
print('var_str = ',var_str);

print("test",int(var_float) );